    ...
    methods: {
        getAgents() {
            listAgents().then(response => {
                ...
                console.log("in mounted humanData:", this.humanData)
                this.drawChart();
            })
        },
        ...
        drawChart() {
            ...
            console.log("human data:", this.humanData)
            this.humanData.forEach(item => {
                console.log(item)
                // var circle = new window.BMap.Circle(new window.BMap.Point(item.longitude, item.latitude), 10, {
                var circle = new window.BMap.Circle(new window.BMap.Point(116.2771171, 39.87783755), 10, {
